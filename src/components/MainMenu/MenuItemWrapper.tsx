...
export const MenuItemWrapper: React.FC<MenuItemWrapperProps> = ({
  ...
  return (
    <div
      className="odd:bg absolute flex w-fit md:min-w-44 min-w-32 md:max-w-44 max-w-min-w-32 transform items-center gap-2 bg-gradient-to-l from-opacityBlue01 to-opacityRed01 px-2 py-1 text-xs font-semibold uppercase drop-shadow-xl backdrop-blur-sm md:text-sm lg:py-2 2xl:text-lg [&_*]:uppercase 3xl:text-xl 4xl:text-2xl 5xl:text-3xl"
      ref={itemRef}
    >
      {children}
    </div>
